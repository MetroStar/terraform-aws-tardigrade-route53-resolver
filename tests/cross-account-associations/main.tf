...
module "ram_share" {
  source = "git::https://github.com/MetroStar/terraform-aws-tardigrade-ram-share.git?ref=4.1.0"
  providers = {
    aws = aws.owner
  }
...
module "ram_share_accepter" {
  source = "git::https://github.com/MetroStar/terraform-aws-tardigrade-ram-share.git//modules/cross_account_principal_association?ref=4.1.0"
